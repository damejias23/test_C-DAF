...
// AssertCdafCreateEventSubscriptionConstraints checks if the values respects the defined constraints
func AssertCdafCreateEventSubscriptionConstraints(obj CdafCreateEventSubscription) error {
	return nil
}
