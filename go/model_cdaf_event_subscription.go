...
// AssertCdafEventSubscriptionConstraints checks if the values respects the defined constraints
func AssertCdafEventSubscriptionConstraints(obj CdafEventSubscription) error {
	return nil
}
